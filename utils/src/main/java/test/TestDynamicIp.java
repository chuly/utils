...
public class TestDynamicIp {
	...
	public static void main(String[] args) {
		...
		String order = "a36067644c76e5bf53fe32806b479db1";//"一定要把这里改为单号哦~";
		// 你要抓去的目标网址
	...
	public class Crawler extends Thread{
		...
		public String webParseHtml(String url) {
			String html = "";
			BrowserVersion[] versions = {BrowserVersion.INTERNET_EXPLORER, BrowserVersion.CHROME, BrowserVersion.FIREFOX_45};
